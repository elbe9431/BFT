<?php
	include("Includes/header_templ_mon.php");
	...
	$fullDelJobFieldList = Evaluator::getFullDeletedBerufsfelder($session, $delJobFields, $rescJobs );
	$currentListInfos .= ListInfo::printListInfo($fullDelJobFieldList);
	...
	*/
	...
	if(!$beruf == ''){
		...
		$and ='?';
				...
				// Output the result ... 
				$dwoo->output('Includes/template/phase1_mon.tpl', $data);
